...
## Summary
- 1997 nodes · 4247 edges · 142 communities (108 shown, 34 thin omitted)
...
10. `load_build_with_role()` - 18 edges
...
### Community 15 - "api.ts"
Cohesion: 0.09
Nodes (26): CreateTenantDialog(), TopNav(), Build, client, GithubInstallation, onRequest(), PersonalToken, Project (+18 more)
...
### Community 19 - "cn"
Cohesion: 0.12
Nodes (22): DialogOverlay(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuSeparator() (+14 more)
...
Cohesion: 0.24
Nodes (12): ComparisonFilter, ComparisonList(), filterComparisons(), FILTERS, useComparisonFilter(), BuildStatusBadge(), Comparison, useBuilds() (+4 more)
...
### Community 141 - "t.$tenantSlug.settings.tsx"
Cohesion: 0.14
Nodes (19): UserMenu(), Select(), SelectContent(), SelectGroup(), SelectItem(), SelectLabel(), SelectScrollDownButton(), SelectScrollUpButton() (+11 more)

## Knowledge Gaps
- **217 isolated node(s):** `CiMode`, `CI_MODE_DESCRIPTION`, `ActiveModel`, `ActiveModel`, `ActiveModel` (+212 more)
...
- **What connects `CiMode`, `CI_MODE_DESCRIPTION`, `ActiveModel` to the rest of the system?**
