...
## Summary
- 2176 nodes · 4718 edges · 151 communities (118 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e44d94e0`
...
Cohesion: 0.19
Nodes (23): a_bundle_without_an_index_fails_the_build_with_a_reason(), assert_completed_at_is_stamped(), build_id_of(), bundle_zip(), bundle_zip_with_index(), bundles_larger_than_the_default_body_limit_are_accepted(), chromium_or_skip(), Fixture (+15 more)
...
Cohesion: 0.05
Nodes (41): BuildMode, BuildStatus, Model, BuildStatus, DateTimeWithTimeZone, Entity, HasMany, HasOne (+33 more)

### Community 6 - "src/auth.rs"
Cohesion: 0.06
Nodes (66): bind_sql(), column_exists(), connect_database(), db_max_connections(), execute_bound(), is_postgres_unique_violation(), query_one_bool(), C (+58 more)

### Community 7 - "service/src/github.rs"
Cohesion: 0.13
Nodes (20): build(), changes_detected_description_counts_all_difference_kinds(), claim_installation(), CommitState, find_installation(), list_installations_for_tenant(), list_unclaimed_installations(), post_commit_status() (+12 more)
...
Cohesion: 0.14
Nodes (22): AppError, DbErr, Error, From, IntoResponse, Self, Scope, me() (+14 more)
...
Cohesion: 0.07
Nodes (27): LocalStorageBackend, ByteStream, Into, PathBuf, Result, Self, validate_key(), delete_rejects_invalid_key() (+19 more)
...
### Community 32 - "JobState"
Cohesion: 0.08
Nodes (62): build_storage(), build_storage_for_queue(), enqueue(), enqueue_best_effort(), GithubStatusJob, process(), Arc, BoxDynError (+54 more)
...
Cohesion: 0.06
Nodes (70): build_lock(), content_type_for(), ensure_extracted(), extracts_once_and_serves_index_and_nested_asset(), local_storage(), rejects_traversal_and_missing(), resolve_asset(), Arc (+62 more)
...
Cohesion: 0.26
Nodes (20): CiPingResponse, create_build(), finalize_build(), get_build_status(), ping(), resolve_baseline_commit_sha(), BuildResponse, Bytes (+12 more)

### Community 47 - "service/src/comparisons.rs"
Cohesion: 0.22
...
### Community 53 - "service/src/tenants.rs"
Cohesion: 0.17
...
Cohesion: 0.15
Nodes (15): base_settings(), check(), default_allow_origin(), default_listen_addr(), default_local_upload_dir(), default_storage_backend(), default_storybook_cache_dir(), load_settings() (+7 more)
...
Cohesion: 0.50
Nodes (3): create_http_client(), Error, Result
...
### Community 88 - "Client"
Cohesion: 0.21
Nodes (12): BuildResponse, Client, CreateBuildBody, FinalizeBody, Option, Response, Result, Self (+4 more)
...
### Community 142 - "service/src/projects.rs"
Cohesion: 0.27
...
### Community 143 - "RedisConnection"
Cohesion: 0.16
Nodes (15): RedisConnection, Error, Result, Self, build_target_url(), cache_get(), cache_set(), github_app() (+7 more)

### Community 144 - "oauth.rs"
Cohesion: 0.21
Nodes (13): credentials(), OAuthProviderEntry, OAuthRegistry, OAuthStatePayload, Arc, Error, HashMap, Option (+5 more)

### Community 145 - "server.rs"
Cohesion: 0.37
Nodes (16): job_state_from(), Box, Error, JoinHandle, Result, String, run(), shutdown_signal_inner() (+8 more)

### Community 146 - "GithubInstallationResponse"
Cohesion: 0.21
...
### Community 147 - "create_personal_token"
Cohesion: 0.28
Nodes (12): create_personal_token(), get_owned_token(), list_personal_tokens(), revoke_personal_token(), Json, Model, Path, Result (+4 more)

### Community 148 - "RedisStateStore"
Cohesion: 0.24
Nodes (7): RedisStateStore, Error, Option, Result, Self, String, StateStore
...
- **Why does `AppState` connect `AppState` to `src/auth.rs`, `handlers/auth.rs`, `RedisConnection`, `oauth.rs`, `handlers/github.rs`, `server.rs`, `create_personal_token`, `AppError`, `AuthUser`, `TestApp`, `csrf.rs`, `service/src/screenshots.rs`, `load_build_with_role`, `ProjectResponse`, `handlers/ci.rs`, `review_comparison`, `get_baseline_entry_content`, `Settings`, `Client`?**
  _High betweenness centrality (0.264) - this node is a cross-community bridge._
- **Why does `TestApp` connect `TestApp` to `vrt_flow_integration.rs`, `render_flow_integration.rs`, `github_integration.rs`, `payload/src/builds.rs`, `AppState`, `tenants_integration.rs`, `Uuid`, `projects_integration.rs`, `Client`, `personal_tokens_integration.rs`, `.new_with`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `AppError` connect `AppError` to `get_baseline_entry_content`, `service/src/builds.rs`, `service/src/screenshots.rs`, `load_build_with_role`, `service/src/github.rs`, `ProjectResponse`, `ServerError`, `handlers/ci.rs`, `service/src/comparisons.rs`, `service/src/projects.rs`, `handlers/github.rs`, `create_personal_token`, `service/src/tenants.rs`, `AuthUser`, `review_comparison`?**
