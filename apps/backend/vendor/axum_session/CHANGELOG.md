...
## 0.20.1 (9. May, 2026)
### Fixed
- Issue where the Advanced Features were behind pub(crate). @Freshcobar

### Added
- (Advanced) remove_stored_database_session to remove known sessions manually from the database. @Freshcobar

## 0.20.0 (30. April, 2026)
### Fixed
